...
public class DesignCompanyRecord extends DesignRecord{
    ...
    public DesignCompanyRecord(int id, String email, String firstName, String lastName, String designStatus, String fileName,
        ...
        super(id, email, firstName, lastName, designStatus, fileName, originalPath, resizedPath, uploadDate, price, projectId);
